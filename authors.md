...
Baltazar P (2026). *zujson: Lightweight JSON Parsing and Serialization*.
R package version 0.1.0, <https://github.com/pedrobtz/zujson>.

    @Manual{,
      title = {zujson: Lightweight JSON Parsing and Serialization},
